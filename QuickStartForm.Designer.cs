namespace SimpleHttp
{
	partial class QuickStartForm
	{
		...
		private void InitializeComponent()
		{
			...
			// folders
			// 
			this.folders.SelectedPath = "I:\\Code\\Nodes\\PipeMania\\PipeManiaService\\Resources";
    ...
    "Information Exchange (*.pkx)|*.pfx|All files(*.*)|*.*";
			...
			this.tbPassword.Text = "I:\\Code\\Nodes\\PipeMania\\PipeManiaService\\Resources";
