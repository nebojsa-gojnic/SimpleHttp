...
namespace WebSockets
{
    ...
    public class HttpServiceFactory : IHttpServiceFactory
    {
		...
		public static HttpServiceFactory createTestFactory ( string message ) 
		{
			HttpServiceFactory ret = new HttpServiceFactory ( (string)null ) ;
        ...
        public HttpServiceFactory ( Assembly resourceAssembly ) : this ( null , resourceAssembly , "" ) 
        {
		...
		public HttpServiceFactory ( string webroot ) : this ( webroot , null , "" ) 
        {
		...
		protected HttpServiceFactory ( string webroot , Assembly resourceAssembly , string message )
		{
